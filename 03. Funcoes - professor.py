...
'''
# Função
def calcular_total_vendido(recebe_valor):
    ...
    if valor_vendido_input <= 4000:
        ...
        comissao = 0.10 # 10%
           ...
           # 0                                     , 1
    return recebe_valor + (recebe_valor * comissao), comissao
...
# calcular o valor total a receber considerando a comissao
# 0=5250, 1=0.05
valor_a_pagar = calcular_total_vendido(valor_vendido_input)

# Resultados
print(f'Vendedor: {nome_vendedor}')
print(f'Comissão aplicada: {int(valor_a_pagar[1] * 100)}%')
